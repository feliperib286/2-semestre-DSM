...
export function App() {
  ...
  let [nome, setNome] = useState<string>("");  // Nome será um valor de string
  let [idade, setIdade] = useState<string>(""); // Idade será um valor de string
  let [lista, setLista] = useState<Person[]>([]); // Lista de pessoas, inicialmente vazia
